...
def About():
    messagebox.showinfo("About", "PID Controller Shoulder Movement by Dzikrur Rohmani Z R M H.\n\nBiomedical Engineering Department\nInstitut Teknologi \
...
if __name__ == "__main__":
    ...
    # Declare Attribute
    TitlePos = Frame(window, width=1050, height=40, background='#e2e6e2')
    TitlePos.pack()
    TitlePos.pack_propagate(0)

    Title = Label(TitlePos, text="Shoulder Joint Movement Model and Control Simulation", font=font9, bg='#e2e6e2')
    Title.pack(pady=5, expand=YES, side=TOP)

    MainPos = Frame(window, width=1050, height=550, background='#e2e6e2')
    MainPos.pack()
    MainPos.pack_propagate(0)

    MainPos1 = Frame(MainPos, width=1050, height=400, background='#e2e6e2')
    MainPos1.pack()
    MainPos1.pack_propagate(0)

    OpenGLPos = LabelFrame(MainPos1, width=682, height=400, text='''OPEN GL''', background='#e2e6e2',
                                labelanchor=N)
    OpenGLPos.pack(padx=11, side=LEFT)
    OpenGLPos.pack_propagate(0)

    embed = LabelFrame(OpenGLPos, width=650, height=360, background='#e2e6e2')
    embed.pack(expand=YES)
    os.environ['SDL_WINDOWID'] = str(embed.winfo_id())
    os.environ['SDL_VIDEODRIVER'] = 'windib'

    TombolPos = Frame(MainPos1, width=368, height=400, background='#e2e6e2')
    TombolPos.pack(padx=(5, 15), side=TOP)

    mf2 = Frame(TombolPos, width=360, height=70, background='#e2e6e2')
    mf2.pack(padx=0, pady=(3, 0))
    mf2.pack_propagate(0)
    mf2_1 = Frame(mf2, width=180, height=50, bg="#e2e6e2")
    mf2_1.pack(side=LEFT)
    mf2_2 = Frame(mf2, width=180, height=50, bg="#e2e6e2")
    mf2_2.pack(side=RIGHT)
    
    UpView = Frame(MainPos1, width=368, height=400, background='#e2e6e2')
    UpView.pack(padx=5)
    ...
    MainPos2 = Frame(MainPos, width=1050, height=150, background='#e2e6e2')
    MainPos2.pack()
    MainPos2.pack_propagate(0)
    Ax1Pos = Frame(MainPos2, width=260, height=150, background='#e2e6e2')
    Ax1Pos.pack(side=LEFT)
    Ax1Pos.pack_propagate(0)
    Ax2Pos = Frame(MainPos2, width=260, height=150, background='#e2e6e2')
    Ax2Pos.pack(side=LEFT)
    Ax2Pos.pack_propagate(0)
    Ax3Pos = Frame(MainPos2, width=260, height=150, background='#e2e6e2')
    Ax3Pos.pack(side=LEFT)
    Ax3Pos.pack_propagate(0)
    Ax4Pos = Frame(MainPos2, width=260, height=150, background='#e2e6e2')
    Ax4Pos.pack(side=LEFT)
    ...
    mf2_1_button1 = Button(mf2_1, width=15, text="START", command=Start)
    mf2_1_button1.pack(pady=5)
    mf2_1_button2 = Button(mf2_2, width=15, text="STOP", command=Stop)
    mf2_1_button2.pack(pady=5)
    mf2_1_button3 = Button(mf2_1, width=15, text="CLEAR", command=Clear)
    mf2_1_button3.pack(pady=5)
    mf2_1_button4 = Button(mf2_2, width=15, text="ABOUT", command=About)
    mf2_1_button4.pack(pady=5)
    mf2_1_button4 = Button(TombolPos, width=15, text="CLOSE", command=Close)
    mf2_1_button4.pack(pady=5)

    rmse = Frame(TombolPos, bg="#e2e6e2")
    rmse.pack(pady=(10, 10))
    rmse1 = Label(rmse, text="RMSE\t=", bg="#e2e6e2")
    rmse1.pack(side=LEFT)
    rmse2 = Entry(rmse, width=10, justify=CENTER)
    rmse2.pack(padx=10, side=RIGHT)
